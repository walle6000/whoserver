...
@Entity
@Table(name = "topicfundexchange")
public class TopicFundExchange implements Serializable {
	@JsonProperty("id")
	@Id
	...
	public TopicFundExchange() {
		super();
	}

	public TopicFundExchange id(Long id) {
		this.id = id;
		return this;
	}
	/**
	...
	public boolean equals(java.lang.Object o) {
		...
		TopicFundExchange tag = (TopicFundExchange) o;
