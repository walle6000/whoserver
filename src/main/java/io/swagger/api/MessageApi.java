...
public interface MessageApi {
    ...
    @ApiOperation(value = "send an message to other users in a topic", notes = "", response = InlineResponse200.class, tags={ "message", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<InlineResponse200> sendMessageOfTopic(@ApiParam(value = "ID of topic to return",required=true ) @PathVariable("topicId") Long topicId,
